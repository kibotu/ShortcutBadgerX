...
object ShortcutBadger {
    ...
    init {
        BADGERS.add(AdwHomeBadger::class.java)
        BADGERS.add(ApexHomeBadger::class.java)
        BADGERS.add(DefaultBadger::class.java)
        BADGERS.add(NewHtcHomeBadger::class.java)
        BADGERS.add(NovaHomeBadger::class.java)
        BADGERS.add(SonyHomeBadger::class.java)
        BADGERS.add(AsusHomeBadger::class.java)
        BADGERS.add(HuaweiHomeBadger::class.java)
        BADGERS.add(OPPOHomeBader::class.java)
        BADGERS.add(SamsungHomeBadger::class.java)
        BADGERS.add(ZukHomeBadger::class.java)
        BADGERS.add(VivoHomeBadger::class.java)
        BADGERS.add(ZTEHomeBadger::class.java)
        BADGERS.add(EverythingMeHomeBadger::class.java)
        BADGERS.add(YandexLauncherBadger::class.java)
        BADGERS.add(TranssionHomeBadger::class.java)
    }
    ...
    fun applyCountOrThrow(context: Context, badgeCount: Int) {
        ...
        try {
            sShortcutBadger?.executeBadge(context, requireNotNull(sComponentName), badgeCount)
        } catch (e: Exception) {
        ...
        if (sIsBadgeCounterSupported == null) {
            synchronized(sCounterSupportedLock) {
                ...
                if (sIsBadgeCounterSupported == null) {
                    ...
                    for (i in 0 until SUPPORTED_CHECK_ATTEMPTS) {
                        try {
                            Log.i(
                            ...
                            if (initBadger(context)) {
                                sShortcutBadger?.executeBadge(
                                    context,
                                    requireNotNull(sComponentName),
                                    0
                                )
    ...
    private fun initBadger(context: Context): Boolean {
        ...
        if (sShortcutBadger == null) {
            if (Build.MANUFACTURER.equals("ZUK", ignoreCase = true)) sShortcutBadger =
                ...
                ZTEHomeBadger()
            else if (Build.MANUFACTURER.equals("SAMSUNG", ignoreCase = true)) sShortcutBadger =
                SamsungHomeBadger()
            else if (Build.MANUFACTURER.equals("HUAWEI", ignoreCase = true)
                || Build.MANUFACTURER.equals("HONOR", ignoreCase = true)
            ) sShortcutBadger = HuaweiHomeBadger()
